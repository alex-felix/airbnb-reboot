...
Event.create!(title: "Club at Mayfair", description: "I have money, I got a table, come join!", interests: ["clubs", "mayfaire", "drinking"], starts_at: DateTime.new(2016, 8, 26), ends_at: DateTime.new(2016, 8, 26), user: sam, location: location1)
